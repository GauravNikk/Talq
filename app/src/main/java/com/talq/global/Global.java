...
import com.talq.lists.calls;
import com.talq.models.DefaultDialog;
import com.talq.notify.FCM;
import com.talq.notify.FCMclient;
import nl.changer.audiowife.AudioWife;
import xute.storyview.StoryModel;

/**
 * Created by Codeslu on 10/17/2018.
 */

public class Global {
    public static final String fcmurl = "https://fcm.googleapis.com/";
public static final String packageName = "com.talq";//Enter Your PackageName(iOS bundle id) here for cross platform notifications to work;
    ...
    public static final String Server_Key = "AAAA-wuTVLk:APA91bF9yoKcJHi0DppvUSlGTsnmm36a29BHLs-vO1S3OriJDb7SgIYnt3Q4hbRGyswMVQJyP2Rs38qu8tkeZHpcILxcOKAptWgMBI4kPWsK9nb0cRIBQPIs0IfoJwwzdhzNFPhd5Kc4";
