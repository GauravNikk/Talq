...
import com.talq.Mapbox;
import com.talq.R;
import com.talq.custom.MessageSelectD;
import com.talq.global.Global;

import com.talq.mediachat.VideoA;
    ...
    public void onBind(final Message message) {
                        ...
                        public void onAutoLinkTextClick(AutoLinkMode autoLinkMode, String matchedText) {
                            switch (autoLinkMode) {
                                ...
                                case MODE_PHONE:
                                   ...
                                   Dexter.withContext(Global.chatactivity)
                                ...
                                case MODE_EMAIL:
                                    ...
                                    emailIntent.putExtra(Intent.EXTRA_EMAIL, new String[]{matchedText});
                                    try {
        ...
        if (message.getType().equals("voice")) {
            ...
            MapboxStaticMap staticImage = MapboxStaticMap.builder()
                    ...
                    .cameraPoint(Point.fromLngLat(Double.parseDouble(lng), Double.parseDouble(lat))) // Image's centerpoint on map
                    .cameraZoom(10)
...
//                    "12.0/200x200@2x?access_token=" + Global.conA.getResources().getString(R.string.mapbox_access_token);
    ...
    private class getMap extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                URL mapUrl = new URL("http://maps.google.com/maps/api/staticmap?center=" + lat + "," + lng + "&zoom=15&size=200x200&sensor=false&key=" + Global.conA.getResources().getString(R.string.google_maps_key));
