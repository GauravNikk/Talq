...
import ar.codeslu.Quatro.Quatro;
import ar.codeslu.Quatro.QuatroUser;
import com.talq.Chat;
import com.talq.Groups.Group;
import com.talq.R;
import com.talq.calls.CallerData;
import com.talq.calls.CallerUser;
import com.talq.calls.IncAudioActivity;
import com.talq.calls.IncCallActivity;
import com.talq.global.AppBack;
import com.talq.global.Global;
import com.talq.global.encryption;
import com.talq.lists.OnlineGetter;
...
public class FCMR extends FirebaseMessagingService {
    ...
    FCMR fcmr;
   public static Quatro<CallerUser> quatro;
   public static CallerData callerData = new CallerData();
...
//inside notification
            ...
            if (!Global.blockList.contains(senderId)) {
                ...
                switch (type) {
                    ...
                    case "videoCall":
                        ...
                        Intent jumptocalls = new Intent(this, IncCallActivity.class);
                        jumptocalls.putExtra("name", callerName);
                        jumptocalls.putExtra("ava", callerAva);
                        jumptocalls.putExtra("out", false);
                        jumptocalls.putExtra("channel_id", channelId);
                        jumptocalls.putExtra("id", callerId);
                        jumptocalls.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                        this.startActivity(jumptocalls);
                        Log.wtf("tawgeh", type);
                        Call(map);
                        break;
    ...
    void GetMessage(Map<String, String> map) {
        ...
        if (message.equals("Missed video call") || message.equals("Missed voice call") ){
            if (quatro != null)
            quatro.Dismiss();
        }
        Log.wtf("react", react);
                            ...
                            if (usercalldata.isIncall()) {
                                if (Global.IncAActivity == null && Global.IncVActivity == null) {
                                    ...
                                    if (type.equals("videoCall")) {
                                        ringer = IncCallActivity.class;
                                        callerUser = new CallerUser(callerName, channelId, false);
                                    } else {
                                        ringer = IncAudioActivity.class;
                                        callerUser = new CallerUser(callerName, channelId, true);
                                    }

//                                    jumptocall.addFlags(WindowManager.LayoutParams.FLAG_SHOW_WHEN_LOCKED +
//                                            WindowManager.LayoutParams.FLAG_DISMISS_KEYGUARD +
//                                            WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON +
//                                            WindowManager.LayoutParams.FLAG_TURN_SCREEN_ON);
                                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                                        quatro = new Quatro<CallerUser>(fcmr, getSystemService(NotificationManager.class));
                                        quatro.setUser(callerUser);
                                        quatro.setIcon(R.drawable.logo);
                                        quatro.setcolor(R.color.colorPrimary);
                                        Intent jumptocall = new Intent(fcmr, ringer);
                                        ...
                                        jumptocall.putExtra("myid", mAuth.getCurrentUser().getUid());

                                        quatro.setOpenIntent(jumptocall);
                                        quatro.setDeclineIntent(jumptocall);
                                        quatro.setRingingIntent(jumptocall);

//                                        quatro.setQuatroListener(new CallEvents.QuatroListener<CallerUser>() {
//                                            @Override
//                                            public void onAnswer(Context context, CallerUser user) {
//
//                                            }
//
//                                            @Override
//                                            public void onOpen(Context context, CallerUser user) {
//
//
//                                            }
//
//                                            @Override
//                                            public void onDecline(Context context, CallerUser user) {
//
//
...
//
//                                            @Override
//                                            public void onNotificationShowed(Context context, CallerUser user) {
//
//                                            }
//                                        });

                                        quatro.AddCall(callerUser);
                                    } else {
                                       // startActivity(jumptocall);
                                    }
...
//                            } catch (NullPointerException e) {
//                                Log.wtf("Call",Global.IncAActivity+"");
//                                Log.wtf("Call",Global.IncVActivity+"");
//                                Map<String, Object> map = new HashMap<>();
//                                map.put("incall", false);
//                                mlogs.child(mAuth.getCurrentUser().getUid()).child(callerId).child(channelId).updateChildren(map).addOnSuccessListener(new OnSuccessListener<Void>() {
//                                    @Override
