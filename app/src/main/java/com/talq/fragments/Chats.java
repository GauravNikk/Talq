...
import com.talq.BuildConfig;
import com.talq.Chat;
import com.talq.Contacts;
import com.talq.MainActivity;
import com.talq.R;
import com.talq.adapters.StoryAdapter;
import com.talq.custom.ChatCelect;
import com.talq.datasetters.DialogData;
import com.talq.global.AppBack;
import com.talq.global.Global;
import com.talq.global.encryption;
import com.talq.holders.DialogHolder;
import com.talq.lists.StoryList;
import com.talq.lists.StoryListRetr;
import com.talq.lists.UserData;
import com.talq.lists.UserDetailsStory;
import com.talq.models.DefaultDialog;
import com.talq.story.AddStory;
import com.talq.story.StoryView;
...
prefs = getContext().getSharedPreferences(
    ...
    private boolean Agree() {
        final boolean[] agree = {false};
        if (prefs.getBoolean("agree",false)){
            agree[0] =true;
        }else{
        new AlertDialog.Builder(getContext())
                .setTitle("Prominent Disclosure")
                .setMessage("The app needs to access your contacts to be able to find your friends that use the app" +"\n")
                ...
                .setPositiveButton("I agree", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        agree[0] = true;
                        prefs.edit().putBoolean("agree",true).apply();
                        Log.wtf("Agree","Agree");
                    }
                })
                ...
                .setNegativeButton(android.R.string.no, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        agree[0] = false;
                        prefs.edit().putBoolean("agree",false).apply();
                        Log.wtf("Agree","DisAgree");
                    }
                })
                .setIcon(R.drawable.ic_info_b)
                .show();
        }
        return agree[0];
    }
