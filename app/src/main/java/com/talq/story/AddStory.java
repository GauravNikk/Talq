...
import com.talq.lists.CountryToPhonePrefix;
import com.talq.lists.StoryList;
import com.talq.story.base.BaseActivity;
...
public class AddStory extends BaseActivity implements OnPhotoEditorListener,
        ...
        addS.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Global.check_int(AddStory.this)) {
                    Dexter.withContext(AddStory.this)
                            ...
                            .withListener(new MultiplePermissionsListener() {
                                ...
                                public void onPermissionsChecked(MultiplePermissionsReport report) {
                                    if (report.areAllPermissionsGranted()) {
                                        ...
                                        for (PermissionDeniedResponse s : report.getDeniedPermissionResponses()
                                        ) {

                                            Toast.makeText(AddStory.this, s.getPermissionName(), Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(AddStory.this, R.string.permission_not_given, Toast.LENGTH_SHORT).show();
    ...
    private void saveImage() {
        Dexter.withContext(AddStory.this)
                .withPermissions(Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.READ_CONTACTS, Manifest.permission.WRITE_EXTERNAL_STORAGE)
                .withListener(new MultiplePermissionsListener() {
                    @Override
                    public void onPermissionsChecked(MultiplePermissionsReport report) {
                        ...
                        if (report.areAllPermissionsGranted()) {
                            ...
                            if (ActivityCompat.checkSelfPermission(AddStory.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
